...
public class StravaActivityController {
    ...
    private static final Logger log = LoggerFactory.getLogger(StravaActivityController.class);
    private final StravaActivityServiceImpl trainingActivityService;

    public StravaActivityController(StravaActivityServiceImpl trainingActivityService) {
